                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('jabatan') is-invalid @enderror" aria-label="Default select example" name="jabatan">
                                            ...
                                            <option value="Guru" name="Guru">Guru</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('job') is-invalid @enderror" name="job" rows="5" placeholder="Masukkan job desc anda">{{ old('job') }}</textarea>
